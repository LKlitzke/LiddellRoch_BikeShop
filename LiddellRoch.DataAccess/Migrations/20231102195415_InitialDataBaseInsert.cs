...
{
    /// <inheritdoc />
    public partial class InitialDataBaseInsert : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5784), "Mountain Bike", 1 },
                    { 2, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5796), "Estrada", 2 },
                    { 3, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5798), "Gravel", 3 },
                    { 4, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5799), "Elétrica", 4 },
                    { 5, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5799), "Urbano e Lazer", 5 },
                    { 6, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5800), "BMX", 6 },
                    { 7, new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5801), "Clássico", 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Marechal Floriano", "29255-000", new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5959), "Av Arthur Haese", "ES", "Uprise Eventos", "1234567890" },
                    { 2, "Domingos Martins", "29260-000", new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5961), "Tv. Augusto Schwambach", "ES", "Agência AJM", "0987654321" },
                    { 3, "Serra", "29160-904", new DateTime(2023, 11, 2, 16, 54, 15, 730, DateTimeKind.Local).AddTicks(5962), "Av. Brg. Eduardo Gomes", "ES", "EryZ FuturAI", "1029384756" }
                });
